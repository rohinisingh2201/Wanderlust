...
app.use(express.urlencoded({extended: true})); //for data to be parsed
app.use(methodOverride("_method"));
app.engine('ejs', ejsMate);
app.use(express.static(path.join(__dirname, "/public"))); //for static css styling files
